...
abstract contract BaseKelpRenzoProxy is ReentrancyGuard, RockOnyxAccessControl {
    ...
    function withdrawFromZircuitRestakingProxy(uint256 ethAmount, address addressWithdraw) external virtual nonReentrant {}

    function withdrawFromKelpRestakePool(uint256 ethAmount, address addressWithdraw) external virtual nonReentrant {}
