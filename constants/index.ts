...
export const EETH_ADDRESS: { [key in CHAINID]?: string } = {
  [CHAINID.ETH_MAINNET]: "0x35fa164735182de50811e8e2e824cfb9b6118ac2",
}
...
export const ETHERFI_DEPOSIT_ADDRESS: { [key in CHAINID]?: string } = {
    [CHAINID.ETH_MAINNET]: '0x308861A430be4cce5502d0A12724771Fc6DaF216',
...
export const WEETH_ETH_PRICE_FEED_ADDRESS: { [key in CHAINID]?: string } = {
  [CHAINID.ETH_MAINNET]: "0x5c9C449BbC9a6075A2c061dF312a35fd1E05fF22",
